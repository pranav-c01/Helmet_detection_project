...
class MultiClassObj:
    def __init__(self, imagePath, modelPath):
        ...
        self.class_names_mapping = {
            1: "Helmet", 2: "with_helmet", 3: "without_helmet"
        }
    ...
    def getPrediction(self):
        ...
        try:
            top_classes = top_classes[top_classes >= 1.0]
            res_list = [top_classes[i] for i in res]
        except:
            return [{"Message":"No object detected"}]
        # print("*******"*50,"YAha tak pahuch gya ","************90"*20)
...
## Helmet detection proj
        try:
            ...
            try:
                ...
                print("Output Image create")
            except:
                print("Cannot produce outputimg.jpg")
